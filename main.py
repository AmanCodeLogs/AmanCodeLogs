...
{ascii_block}
  ...
  <text x="{STATS_X}" y="280" class="animated-line" style="animation-delay: 2.0s;"><tspan class="text-dim">.</tspan><tspan class="keyword">stack.roots:</tspan><tspan class="text-dim"> ............. </tspan><tspan class="property">python,go,c,C++</tspan></text>
