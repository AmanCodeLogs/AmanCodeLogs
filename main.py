...
{ascii_block}
  ...
  <text x="{STATS_X}" y="240" class="animated-line" style="animation-delay: 1.8s;"><tspan class="text-dim">.</tspan><tspan class="keyword">stack.side:</tspan><tspan class="text-dim"> .............. </tspan><tspan class="property">langchain, tensorflow, opencv</tspan></text>
  <text x="{STATS_X}" y="260" class="animated-line" style="animation-delay: 1.9s;"><tspan class="text-dim">.</tspan><tspan class="keyword">stack.infra:</tspan><tspan class="text-dim"> ............. </tspan><tspan class="property">sqlite, linux</tspan></text>
  <text x="{STATS_X}" y="280" class="animated-line" style="animation-delay: 2.0s;"><tspan class="text-dim">.</tspan><tspan class="keyword">stack.roots:</tspan><tspan class="text-dim"> ............. </tspan><tspan class="property">c, c++</tspan></text>
